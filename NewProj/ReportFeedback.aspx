<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportFeedback.aspx.cs" Inherits="ReportFeedback" %>
    ...
    <nav id="mainNavbar" class="navbar navbar-dark bg-body-tertiary navbar-expand-md py-0 fixed-top">
        ...
        <div class="collapse navbar-collapse flex-column align-items-end justify-content-end" id="navLinks">
            <ul class="navbar-nav">
                ...
                <li class="navbar-item">
                    <a href="#" class="nav-link" onclick="openAttendanceform()"
    ...
    <div class="col-md" style="margin-top:100px">
        ...
        <div class="form-group">
            <table class="table table-striped table-bordered">
                ...
                <asp:Repeater ID="REPORT1" runat="server">
